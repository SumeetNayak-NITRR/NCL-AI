            ...
            <div className="absolute inset-0 flex items-end justify-center z-0 overflow-hidden">
                {player.photo_url ? (
                    <img
                        ...
                        alt={player.name}
                        className="h-[95%] w-auto object-contain drop-shadow-[0_0_30px_rgba(0,0,0,0.5)] transition-all duration-500 filter grayscale brightness-75 group-hover:grayscale-0 group-hover:brightness-100 group-hover:scale-105"
                        style={{
