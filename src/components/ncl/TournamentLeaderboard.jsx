...
const StatCard = ({ title, icon: Icon, color, data, valueKey, label, loading }) => (
    <div className="bg-black/40 border border-white/10 rounded-xl overflow-hidden backdrop-blur-sm flex flex-col h-full">
                ...
                <div className="p-4 space-y-4">
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="flex items-center gap-3 animate-pulse">
                            <div className="w-4 h-6 bg-white/5 rounded"></div>
