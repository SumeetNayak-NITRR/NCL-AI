                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-6">
                    <div>
                        ...
                        <div className="w-full max-w-[280px] mx-auto mb-4">
                            ...
                            <div className="w-full max-w-[280px] mx-auto mb-16 relative" style={{ height: '392px' }}>
                                <div style={{
                                    width: '450px',
                                    height: previewType === 'auction' ? '630px' : '600px',
                                    transform: 'scale(0.622222)',
                                    transformOrigin: 'top left',
                                    position: 'absolute',
                                    top: 0,
                                    left: 0
                                }} className="bg-black rounded-xl overflow-hidden shadow-2xl">
                                    <div ref={cardRef} className="transform hover:scale-[1.02] transition-transform duration-300 origin-center">
                                        {previewType === 'auction' ? (
                                            <PlayerCard
                                                player={{
                                                    ...formData,
                                                ...
                                                size="large" // Use Large size scaled down for WYSIWYG
                                            />
                                        ) : (
                                            <AbstractPlayerCard
                                                player={{
                                ...
                                <p className="text-center text-xs text-white/40 font-rajdhani uppercase tracking-widest absolute -bottom-6 w-full">Live Preview</p>
                            </div>
