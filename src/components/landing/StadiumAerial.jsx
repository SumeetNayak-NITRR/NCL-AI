        ...
        >
            ...
            <div className="sticky top-0 h-[100dvh] overflow-hidden">
                ...
                >
                    ...
                    {/* Secondary floodlights - hidden on mobile */}
                    <motion.div
                        className="hidden md:block absolute top-[5%] left-[15%] w-[500px] h-[500px] rounded-full bg-[#ffd700]"
                        style={{ scale: floodlightScale, filter: `blur(${floodlightBlur}px)`, willChange: 'transform, opacity' }}
                ...
                <motion.div
                    ...
                    style={{ opacity: midfieldOpacity, scale: midfieldScale }}
                >
                    <motion.div
